 ...
 */
public class MorelliBranch extends Branch {

    public MorelliBranch(double incubation_k, double incubation_theta, double d, double guess, double R0){
        incubationPeriod=GammaDistribution.nextGamma(incubation_k, incubation_theta);
        double infectious_k = guess/Math.pow(d,2);
        double infectious_theta = Math.pow(d,2);
