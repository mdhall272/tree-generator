 ...
 */
public class TruncNormalGammaBranch extends Branch {

    public TruncNormalGammaBranch(double incubation_mean, double incubation_stdev, double infectious_k, double infectious_theta,
                                  double R0){
        incubationPeriod = -1;
        while(incubationPeriod<=0){
            incubationPeriod = incubation_stdev*MathUtils.nextGaussian()+incubation_mean;
        }
